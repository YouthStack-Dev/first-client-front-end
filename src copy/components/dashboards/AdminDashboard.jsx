...
const AdminDashboard = () => {
  ...
  const dummyVehicles = [
    { id: 'V001', licensePlate: 'KA01AB1234', status: 'Active', driver: 'John Doe' },
    { id: 'V002', licensePlate: 'MH12CD5678', status: 'On Trip', driver: 'Jane Smith' },
    { id: 'V003', licensePlate: 'DL04EF4321', status: 'Maintenance', driver: 'Bob Johnson' },
    { id: 'V004', licensePlate: 'TN09XY9876', status: 'Active', driver: 'Alice Brown' },
  ];

  const dummyEmployees = [
    { id: 'E101', name: 'Alice Johnson', phone: '9876543210', email: 'alice@company.com', department: 'Engineering' },
    { id: 'E102', name: 'Bob Smith', phone: '9123456780', email: 'bob@company.com', department: 'Marketing' },
    { id: 'E103', name: 'Charlie Brown', phone: '9988776655', email: 'charlie@company.com', department: 'Sales' },
    { id: 'E104', name: 'Diana Prince', phone: '9555666777', email: 'diana@company.com', department: 'HR' },
  ];

  const dummyTrips = [
    { id: 'T001', description: 'Morning office commute', route: 'Home → Office', status: 'Completed' },
    { id: 'T002', description: 'Evening return journey', route: 'Office → Home', status: 'In Progress' },
    { id: 'T003', description: 'Client meeting - Downtown', route: 'Office → Client Site', status: 'Scheduled' },
    { id: 'T004', description: 'Airport pickup', route: 'Airport → Office', status: 'Pending' },
  ];
  ...
  const SearchInput = ({ 
    ...
    <div className="relative group">
      <label className="block text-sm font-semibold text-gray-700 mb-3 group-hover:text-gray-900 transition-colors">
        {label}
        <span className="text-xs font-normal text-gray-500 ml-2">({shortcut})</span>
      </label>
      ...
      {suggestions && (
        <div className="absolute z-20 mt-2 w-full bg-white/95 backdrop-blur-md 
              ...
              >
                <div className="flex flex-col">
                  ...
                  <span className="text-sm text-gray-500">
                    {type === 'vehicle' ? `${item.licensePlate} • ${item.driver}` :
                     type === 'employee' ? `${item.name} • ${item.department}` :
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
            ...
            <SearchInput
              ...
              suggestions={focusedInput === 'employee' ? filteredEmployees : null}
              onSuggestionClick={handleSuggestionClick}
              type="employee"
              shortcut="Ctrl+E"
            />
                ...
                return (
                  <div
                    ...
                    className={`bg-white rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 
                             ...
                             ${statsLoaded ? 'animate-in slide-in-from-bottom-4' : ''}`}
                  ...
                  >
                    <div className="p-6">
                      ...
                      <div className="flex items-end justify-between">
                        ...
                        <div className="text-xs font-medium text-green-600 bg-green-50 
        ...
        {modalOpen && (
          <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50
            ...
            <div className="bg-white rounded-2xl p-8 max-w-md w-full mx-4 shadow-2xl 
              ...
              <div className="mb-8">
                <div className="w-16 h-16 bg-gradient-to-r from-blue-500 to-blue-600 
                ...
                <p className="text-gray-600 leading-relaxed">
                  ...
                  detailed analytics and management capabilities for this metric.
                </p>
              </div>
