  ...
  return (
    <div className="relative inline-flex items-center">
      ...
      >
        ...
        />
        <div
          className={`${sizeClasses[size]} rounded-full peer ${
        ...
        <span
          className={`ml-2 font-medium ${textSizes[size]} ${
      ...
      {loading && (
        <div
          className={`absolute -top-8 left-1/2 transform -translate-x-1/2 px-2 py-1 bg-gray-800 text-white text-xs rounded whitespace-nowrap transition-opacity duration-150 ${
