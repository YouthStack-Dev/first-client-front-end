...
import { ShieldCheck, Plus, RefreshCw, Search, Download } from "lucide-react";
import {
  dummyRoledata,
  mockAllowedModules,
  staticEmployees,
        ...
        leftElements={
          <div className="flex items-center gap-4 flex-wrap">
            ...
            <ReusableButton
              ...
              action="read"
              icon={RefreshCw}
              title="Synchronize roles with external systems"
              buttonName="Sync"
              onClick={handleSync}
              loading={loading}
              loadingText="Syncing..."
      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          ...
          <div className="bg-green-50 p-4 rounded-lg border border-green-200">
            <div className="text-green-600 font-semibold">Assignable Roles</div>
            <div className="text-2xl font-bold text-green-800">
              {roles.filter((r) => r.isAssignable).length}
            </div>
          </div>
          <div className="bg-purple-50 p-4 rounded-lg border border-purple-200">
            <div className="text-purple-600 font-semibold">System Roles</div>
          ...
          <div className="bg-orange-50 p-4 rounded-lg border border-orange-200">
            ...
            <div className="text-2xl font-bold text-orange-800">
              {roles.reduce((sum, role) => sum + role.assignedUsers.length, 0)}
            </div>
          </div>
        </div>
