...
import {
  LayoutDashboard, User, Users2, UserCog, UserPlus, Car, CarTaxiFront,
  Calendar, ClipboardList, Route, Building2, MessageCircleCode
} from 'lucide-react';
...
export const menuItems = [
  ...
  { path: '/vehicle-contract', name: 'Vehicle Contract', icon: Car, permissionModule: 'vehicle-contract' },
  { path: '/vendor-contract', name: 'Vendor Contract', icon: Building2, permissionModule: 'vendor-contract' },
  { path: '/vehicle-contracts/adjustment-penalty', name: 'Adjustment & Penalty', icon: ClipboardList, permissionModule: 'adjustment-penalty' },
  { path: '/vehicle-contracts/cost-center', name: 'Cost Center', icon: Building2, permissionModule: 'cost-center' },
  { path: '/vehicle-contracts/master-contracts', name: 'Master Contracts', icon: ClipboardList, permissionModule: 'show-contractsInMaster' },
