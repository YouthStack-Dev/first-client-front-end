...
const navigate = useNavigate()
  ...
  const handleBookingClick = (employee) => {
    navigate(`/employee/${employee.employee_id}/bookings`, { state: { employee } });
  };
            ...
            {loading ? (
              ...
              employees.map((employee) => (
                ...
                >
                  ...
                  <td className="p-3 border-r border-gray-100 font-medium text-gray-900">{employee.name}</td>
                  <td className="p-3 border-r border-gray-100 text-gray-600">{employee.employee_code}</td>
                  <td className="p-3 border-r border-gray-100 text-gray-600">{employee.email}</td>
                  <td className="p-3 border-r border-gray-100 text-gray-600">{employee.phone}</td>
                  ...
                  <td className="p-3 border-r border-gray-100" onClick={(e) => e.stopPropagation()}>
                    <ReusableToggleButton
                      ...
                      loading={isProcessing && pendingStatusChange?.employeeId === employee.employee_id}
