        ...
        <div className="flex items-center space-x-2">
          {!isReadOnly && (
            <label className="flex-1 cursor-pointer">
              <div
                className={`border-2 border-dashed rounded-lg p-3 text-center hover:border-blue-400 transition-colors ${
                  hasDocument
