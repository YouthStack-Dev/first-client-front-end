...
//  * LiveTracking
//  *
//  * Renders a full-height map + sidebar panel showing ongoing routes.
//  * - Accepts normalized API routes as props
//  * - Tracks selected drivers via Firebase (useDriverLocations)
//  * - Falls back gracefully when location data is missing
//  */
...
// const LAYOUT = {
//   HEADER_OFFSET: 160,  // topbar + page padding
//   MIN_HEIGHT:    600,  // minimum usable map height
//   INNER_HEADER:  130,  // search bar + title inside card
//   SIDEBAR_WIDTH: 288,  // w-72 = 288px
// };
...
// // trying multiple possible key names
// // ─────────────────────────────────────────────────────────────────────────────
...
// // ─────────────────────────────────────────────────────────────────────────────
// // EmptyRouteState — extracted for readability
// // ─────────────────────────────────────────────────────────────────────────────
...
//         Array.isArray(route.route_stops) ? route.route_stops : [];
...
//       }))
//       .filter((d) => {
//         const isTrackable = d.driverId && d.vendorId;
//         return isTrackable;
//       });
//     return drivers;
//   },
...
//         style={{
//           height:    `calc(100vh - ${LAYOUT.HEADER_OFFSET}px)`,
...
//         <div
//           className="flex"
//           style={{ height: `calc(100% - ${LAYOUT.INNER_HEADER}px)` }}
//         >
...
//             {/* ✅ Small badge only — map always renders */}
//             {!API_KEY && (
...
//             {/* ✅ Always render map — key injected by GitHub at build time */}
 ...
 *
 * Renders a full-height map + sidebar panel showing ongoing routes.
 * - Routes grouped by status (Ongoing first, most urgent)
 * - Max 5 simultaneous tracked routes to protect Firebase performance
 * - Accepts normalized API routes as props
 * - Tracks selected drivers via Firebase (useDriverLocations)
 * - Falls back gracefully when location data is missing
 */
