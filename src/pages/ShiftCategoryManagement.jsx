      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="bg-white rounded-lg shadow p-4">
          ...
          <div className="space-y-2">
            <p className="text-sm">
              Booking Cutoff: <span className="font-bold text-lg text-blue-600">{bookingCutOffEmployee}</span> hours
            </p>
            <button
        ...
        <div className="bg-white rounded-lg shadow p-4">
          ...
          <div className="space-y-2">
            <p className="text-sm">
              Cancellation Cutoff: <span className="font-bold text-lg text-blue-600">{cancellationCutOffEmployee}</span> hours
            </p>
            <button
