...
const ManageTeams = () => {
  ...
  <div className="flex items-center gap-2">
    <button
      className="bg-green-500 hover:bg-green-600 text-white px-3 py-1.5 rounded flex items-center gap-1 text-sm transition-colors"
    >
  ...
  className="bg-indigo-500 hover:bg-indigo-600 text-white px-3 py-1.5 rounded flex items-center gap-1 text-sm transition-colors"
>
  ...
  {/* Download Button */}
  <button
    className="bg-blue-500 hover:bg-blue-600 text-white px-3 py-1.5 rounded flex items-center gap-1 text-sm transition-colors"
  >
  ...
  {/* View History Button */}
  <button
    className="bg-gray-700 hover:bg-gray-800 text-white px-3 py-1.5 rounded flex items-center gap-1 text-sm transition-colors"
  >
  ...
  {selectedTeams.length > 0 && (
    <button
      className="bg-red-600 hover:bg-red-700 text-white px-3 py-1.5 rounded flex items-center gap-1 text-sm transition-colors"
    >
        ...
        <table className="min-w-full table-auto text-sm">
          <thead className="bg-gray-100 sticky top-0 z-10">
            <tr>
              ...
              <th className="px-3 py-2 text-left">Active Employees</th>
              <th className="px-3 py-2 text-left">Inactive Employees</th>
          ...
          <tbody>
            {teams.map((team) => (
              <tr key={team.id} className="border-b hover:bg-gray-50">
                ...
                <td className="px-3 py-2">
                  <button className="text-gray-700 hover:underline">History</button>
                </td>
                <td className="px-3 py-2">
