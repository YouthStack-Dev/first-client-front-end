    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            <span
              className={`w-1.5 h-1.5 rounded-full ${isActive ? "bg-emerald-300" : "bg-rose-200"}`}
            />
          ...
          <div className="flex items-center gap-3 relative z-10">
            <div
              className="w-11 h-11 rounded-xl bg-white/20 border border-white/30
          ...
          <div className="grid grid-cols-3 gap-1.5">
            ...
            <div className="flex items-start gap-1.5 bg-slate-50 rounded-lg px-2.5 py-2 border border-slate-100">
              ...
              <div className="min-w-0">
                ...
                <p className="text-[11px] font-semibold text-slate-700 truncate">
                  {company.policy_package?.name ||
                    `${company.tenant_id}_Default`}
                </p>
              </div>
            </div>
            <div className="flex items-start gap-1.5 bg-slate-50 rounded-lg px-2.5 py-2 border border-slate-100">
        ...
        {toggleError && (
          <div
            className="mx-4 mb-2 flex items-center gap-2 bg-rose-50 border
        ...
        <div
          className={`border-t flex flex-col gap-1.5 px-3 py-2.5
