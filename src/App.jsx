...
import { jwtDecode } from 'jwt-decode';
import Cookies from "js-cookie";
import { setCredentials } from './redux/slices/authSlice'; // ✅ Correct import
        ...
        <Routes>
          ...
          <Route element={<Layout />}>
            <Route element={<ProtectedRouteAuth />}>
              ...
              <Route path="/manage-client" element={<ManageClients />} />
              <Route path="/tracking" element={<TrackingScreen />} />
              <Route path="/switch-office" element={<h1>This is the screen where u can switch to those companies under you</h1>} />
